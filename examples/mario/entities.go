...
func SpawnPlayer(ctx *engine.Context, pos math.Vec2) *Player {
	e := ctx.ECS.NewEntity()
...
func SpawnGoomba(ctx *engine.Context, pos math.Vec2) *Goomba {
	e := ctx.ECS.NewEntity()
...
func UpdateEntities(ctx *engine.Context, lvl *Level, player *Player, goombas []*Goomba, dt float32) []*Goomba {
